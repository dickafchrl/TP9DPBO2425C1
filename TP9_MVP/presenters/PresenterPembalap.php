...
class PresenterPembalap implements KontrakPresenter
{
    ...
    public function initListPembalap()
    {
        ...
        // Buat objek Pembalap dan simpan di list
        $this->listPembalap = [];
    ...
    public function tambahPembalap($nama, $tim, $negara, $poinMusim, $jumlahMenang): void {
        // isi ga ya
        if (empty($nama) || empty($tim) || empty($negara)) {
            // $this->viewPembalap->tampilError("Field wajib tidak boleh kosong.");
            return;
        }
        ...
        // Update view
        // $this->viewPembalap->tampilPesan("Data berhasil di tambahkan");
    }
    
    public function ubahPembalap($id, $nama, $tim, $negara, $poinMusim, $jumlahMenang): void {
        // isi ga ya
        if(empty($id)) {
            // $this->viewPembalap->tampilError("ID tidak valid.");
            return;
        } 
        ...
        // Update view
        // $this->viewPembalap->tampilPesan("Data berhasil di update");
    }
    ...
    public function hapusPembalap($id): void {
        ...
        // Update view
        // $this->viewPembalap->tampilPesan("Data berhasil di hapus");
    }
}
